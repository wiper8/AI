...
backprop <- function(nn, newdata, n_epoch = 100, step_size = 0.5, lr = 1,
...
#' batch_size = 3
#' )
backprop_policy <- function(policy_nn, critic_nn, newdata, n_epoch = 100,
                            step_size = 0.5,
  ...
  repeat {
    ...
    new_mean_reward <- mean(predict.nn(critic_nn, new_inputs))
